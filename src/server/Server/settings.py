...
STATIC_ROOT = os.path.join(BASE_PATH, 'resources', 'static_full')
...
STATICFILES_DIRS = (
    os.path.join(BASE_PATH, 'resources', 'static'),
)
...
SECRET_KEY = 'mg=#@%-abdg2rs=b@2ig82=7t=$j6bs^pg22prch6pl^1ol7sc'
